...
|----------|------|---------|
| 1 | `F:\Bear_Point_Protocol\01_CASE_Fort_Peck_v_Wolf_Point\00_COMMAND_CENTER\_STATUS.md` | Current state, active tasks |
| 2 | `F:\Bear_Point_Protocol\01_CASE_Fort_Peck_v_Wolf_Point\00_COMMAND_CENTER\DEADLINE_TRACKER.md` | SOL dates, filing deadlines |
...
```powershell
robocopy "F:\Bear_Point_Protocol\01_CASE_Fort_Peck_v_Wolf_Point" "D:\Vault back ups\$(Get-Date -Format 'yyyy-MM-dd_HHmm')" /E /Z /MT:8
```
...
```powershell
& "F:\Bear_Point_Protocol\00_PLATFORM\Scripts\01_QA\Catch-Bullshit.ps1" -VaultPath "F:\Bear_Point_Protocol\01_CASE_Fort_Peck_v_Wolf_Point"
```
...
| Case root | `F:\Bear_Point_Protocol\01_CASE_Fort_Peck_v_Wolf_Point` |
